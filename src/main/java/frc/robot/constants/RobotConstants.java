...
public final class RobotConstants {
	...
	public static class Shooter {
		...
		public static final double[][] SHOOTER_RPM_DATA = {
			...
			{5.0, 2660.0 * VELOCITY_MULTIPLE}, // 2630
			{5.3, 2860.0 * VELOCITY_MULTIPLE},
			{5.5, 2870.0 * VELOCITY_MULTIPLE}, // 2630
			{6.0, 3000.0 * VELOCITY_MULTIPLE}, // 2700
			{6.5, 3080.0 * VELOCITY_MULTIPLE}, // 3000
